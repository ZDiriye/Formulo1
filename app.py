...
from update_team_form import check_update_team_form
...
def drivers():
        ...
        drivers_standings_dict = drivers_standings.to_dict(orient="records")
        driver_images_dict = driver_images.to_dict(orient="records")
...
def teams():
        ...
        constructor_standings_dict = constructor_standings.to_dict(orient="records")
        official_team_images_dict = official_team_images.to_dict(orient="records")
...
def teams_form(constructor_id):
    check_update_team_form(constructor_id)
