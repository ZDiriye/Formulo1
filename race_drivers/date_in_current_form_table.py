...
# gets the max date in the sql table CURRENT_FORM given driver id


def get_date_in_current_form_table(driver_id):
    engine = get_database_engine()
    with engine.connect() as connection:
        sql_query = "SELECT MAX(Date) FROM CURRENT_FORM WHERE DriverID = :driver_id;"
